class Game {
  ...
  handleElements() {
    form.hide();
    form.titleImg.position(5, 20);
    form.titleImg.class("gameTitleAfterEffect");

    this.resetTitle.html("Reset Game");
    this.resetTitle.class("resetText");
    this.resetTitle.position(width / 2 + 430, 20);

    this.resetButton.class("resetButton");
    this.resetButton.position(width / 2 + 470, 70);

    this.leadeboardTitle.html("Leaderboard");
    this.leadeboardTitle.class("resetText");
    this.leadeboardTitle.position(30, 200);

    this.leader1.class("leadersText");
    this.leader1.position(35, 240);

    this.leader2.class("leadersText");
    this.leader2.position(35, 280);
  }
  ...
  handleTouchControls() {
    if (!this.blast && touches.length > 0) {
